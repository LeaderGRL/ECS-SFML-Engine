	...
	void LuaAPI::CPP_To_LUA()
	{
		...
		luabridge::getGlobalNamespace(L)
		    .beginNamespace("tgui")
			    ...
			    .endClass()
				.beginClass<tgui::Color>("Color")
					.addConstructor<void (*) (const char*)>()
				.endClass()
				.beginClass<tgui::Borders>("Borders")
					.addConstructor<void (*) (float width, float height)>()
				.endClass()
	        .endNamespace();
		...
		**/
		luabridge::getGlobalNamespace(L)
			.beginNamespace("tgui")
				.beginClass<tgui::ButtonRenderer>("ButtonRenderer")
					.addFunction("SetBackgroundColor", &tgui::ButtonRenderer::setBackgroundColor)
					.addFunction("SetBackgroundColorDisabled", &tgui::ButtonRenderer::setBackgroundColorDisabled)
					.addFunction("SetBackgroundColorHover", &tgui::ButtonRenderer::setBackgroundColorHover)
					.addFunction("SetBackgroundColorFocused", &tgui::ButtonRenderer::setBackgroundColorFocused)
					.addFunction("SetBackgroundColorDown", &tgui::ButtonRenderer::setBackgroundColorDown)
					.addFunction("SetTextColor", &tgui::ButtonRenderer::setTextColor)
					.addFunction("SetTextColorDisabled", &tgui::ButtonRenderer::setTextColorDisabled)
					.addFunction("SetTextColorHover", &tgui::ButtonRenderer::setTextColorHover)
					.addFunction("SetTextColorFocused", &tgui::ButtonRenderer::setTextColorFocused)
					.addFunction("SetTextColorDown", &tgui::ButtonRenderer::setTextColorDown)
					.addFunction("SetBorderColor", &tgui::ButtonRenderer::setBorderColor)
					.addFunction("SetBorderColorDisabled", &tgui::ButtonRenderer::setBorderColorDisabled)
					.addFunction("SetBorderColorHover", &tgui::ButtonRenderer::setBorderColorHover)
					.addFunction("SetBorderColorFocused", &tgui::ButtonRenderer::setBorderColorFocused)
					.addFunction("SetBorderColorDown", &tgui::ButtonRenderer::setBorderColorDown)
					.addFunction("SetBorders", &tgui::ButtonRenderer::setBorders)
				.endClass()
	            ...
	            .deriveClass<tgui::ButtonBase, tgui::ClickableWidget>("ButtonBase")
					...
					.addFunction("GetRenderer",	luabridge::nonConstOverload<>(&tgui::ButtonBase::getRenderer))
		        .endClass()
		        .deriveClass<tgui::Button, tgui::ButtonBase>("Button")
		            .addStaticFunction("Create", &tgui::Button::create)
					.addFunction("SetTextSize", &tgui::Button::setTextSize)
		        .endClass()	
